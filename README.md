...
职途智析是一个岗位技能图谱驱动的职业路径推荐与求职准备工具，集成技能缺口分析、课程/项目推荐、求职记录看板、用户求职上下文和 AI 简历改写能力。

## 产品化入口：职途智析

`职途智析` 是本项目的公网可部署产品入口。用户输入目标岗位和当前技能后，系统输出技能差距、薪资预期、推荐课程、相似岗位、GitHub 参考项目和面试准备问题；扩展工作台支持求职记录管理、PDF 简历版本绑定和岗位版简历改写。
...
当前产品化入口已扩展为“岗位-技能-课程-GitHub开源项目”推荐 demo，内置 38 个岗位样例、83 个技能标签和 23 个 GitHub 开源参考项目，可展示相关开源项目、课程关键词、相似岗位和面试准备问题。
